...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at android.maps
         */
    ...
    public static class AndroidVersionAccessors extends VersionFactory  {
        ...
        private final AndroidMapsVersionAccessors vaccForAndroidMapsVersionAccessors = new AndroidMapsVersionAccessors(providers, config);
        public AndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.android.maps
         */
        public AndroidMapsVersionAccessors getMaps() {
            return vaccForAndroidMapsVersionAccessors;
        }

    }

    public static class AndroidMapsVersionAccessors extends VersionFactory  {

        public AndroidMapsVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: android.maps.utils (2.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getUtils() { return getVersion("android.maps.utils"); }

    }

    public static class FirebaseVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public FirebaseVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the version associated to this alias: firebase (22.1.2)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("firebase"); }

            /**
             * Returns the version associated to this alias: firebase.auth (23.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: firebase.bom (33.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: firebase.database (21.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
